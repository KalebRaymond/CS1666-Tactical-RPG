...
pub fn handle_enemy_turn<'a, 'b>(core: &SDLCore<'b>, p2_units: &mut HashMap<(u32, u32), Unit<'a>>, p1_units: &mut HashMap<(u32, u32), Unit<'a>>, barbarian_units: &mut HashMap<(u32, u32), Unit<'a>>, game_map: &mut GameMap<'b>, turn_banner: &mut Banner, current_player: &mut Team, p2_castle: &(u32, u32), p1_castle: &(u32, u32), camp_coords: &Vec<(u32, u32)>, distance_map: &DistanceMap, unit_textures: &'a HashMap<&str, Texture<'a>>,) -> Result<(), String> {
    if !turn_banner.banner_visible {
        ...
        best_individual.convert_state_to_action(core, p2_units, p1_units, barbarian_units, unit_textures, game_map, p2_castle);
